...
var notie = (function () {
  ...
  function forceShow (type, message, buttonText, callback) {
    ...
    function forceShowInner () {
      ...
      forceOuter.style.display = 'block'
      ...
      setTimeout(function () {
		...
		//forceBackground.style.backgroundColor = '#000000'
		forceBackground.style.filter = 'alpha(opacity=75)'
  ...
  function forceHide () {
	...
	forceBackground.style.filter = 'alpha(opacity=0)'
  ...
  function confirmShow (title, yesText, noText, yesCallback, noCallback) {
    ...
    function confirmShowInner () {
      ...
      confirmOuter.style.display = 'block'
      ...
      setTimeout(function () {
		...
		//confirmBackground.style.backgroundColor = '#000000'
		confirmBackground.style.filter = 'alpha(opacity=75)'
  ...
  function confirmHide () {
	...
	confirmBackground.style.filter = 'alpha(opacity=0)'
  ...
  function inputShow (title, submitText, cancelText, submitCallback, cancelCallback) {
    ...
    function inputShowInner () {
      ...
      setTimeout(function () {
		...
		//inputBackground.style.backgroundColor = '#000000'
		inputBackground.style.filter = 'alpha(opacity=75)'
  ...
  function inputHide () {
	...
	inputBackground.style.filter = 'alpha(opacity=0)'
  ...
  function selectShow (title, cancelText, choices) {
    ...
    for (var i = 0; i < choices.length; i++) {
      ...
      else if(selectChoice.currentStyle){
          selectChoice.style.backgroundColor = selectChoice.currentStyle.backgroundColor
      }
    ...
    function selectShowInner (title) {
      ...
      setTimeout(function () {
		...
		//selectBackground.style.backgrounColor = '#000000'
		selectBackground.style.filter = 'alpha(opacity=75)'
  ...
  function selectHide () {
	...
	selectBackground.style.filter = 'alpha(opacity=0)'
  ...
  function dateShow (dateOptions) {
    ...
    function dateShowInner () {
      ...
      setTimeout(function () {
		...
		//dateBackground.style.backgrounColor = '#000000'
		dateBackground.style.filter = 'alpha(opacity=75)'
  ...
  function dateHide () {
	...
	dateBackground.style.filter = 'alpha(opacity=0)'
